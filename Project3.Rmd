...
#### [__1) Fit a linear regression model__]{.underline}
  ...
  The data now will be split into a train and test sets, and a linear regression model will be fit on the train set. The train set will be 70 percent of the whole data and the remaining 30 % will be the test set.  
```{r}
set.seed(12)
