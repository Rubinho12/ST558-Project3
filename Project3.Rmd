...
```
  ...
  * From the numerical summaries, the results show that there is an average of `r num.summary$tokens.avg` words in the content, an average of `r num.summary$image.avg` images and `r num.summary$vids.avg` videos. The standard deviation of the positive words from the mean is `r num.summary$pos.words.dev` and the number of links varies by a average amount of `r num.summary$links.var`.  
...
The tokens have a median value of `r summary$tokens.med` , the number of images have a standard deviation of `r summary$image.sd`, and the mean of the positive words is `r summary$pos.words.avg`.  
